...
/**
 * Provides the local service interface for Jornada. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see JornadaLocalServiceUtil
...
public interface JornadaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JornadaLocalServiceUtil} to access the jornada local service. Add custom service methods to {@link es.vass.ficha.service.impl.JornadaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Jornada createJornada(long jornadaId);
	...
	*/
	...
	public Jornada deleteJornada(Jornada jornada);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public Jornada deleteJornada(long jornadaId) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jornada fetchJornada(long jornadaId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jornada fetchJornadaByUuidAndGroupId(String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jornada getJornada(long jornadaId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Jornada getJornadaByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Jornada> getJornadas(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Jornada> getJornadasByUuidAndCompanyId(String uuid,
		long companyId);
